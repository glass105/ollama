...
- Do not store private, sensitive, or credential-bearing screenshots in this public repo.
- Do not store model files here.
- For large image sets, use external storage and place a link or note in Markdown memory instead.
