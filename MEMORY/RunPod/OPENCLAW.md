...
For CMM, CMG, Nokia, PDF, XLSX, command, interface, alarm, guide, or reference questions, OpenClaw must run the helper before answering. If it cannot run the helper, it should say the helper failed instead of inventing commands from model memory.
